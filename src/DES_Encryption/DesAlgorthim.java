...
import javax.swing.JOptionPane;
 ...
 class Encryption {
    ...
    PrintWriter pw = new PrintWriter(System.out, true);//insted of "System.out"
...
//permutation Function
    ...
    public void Encryption() {
        ...
        try {
            pw.println("");
            Key= JOptionPane.showInputDialog(null, "Enter 64-bit key (Key should be atleast 8 characters long) : ");
//            Key = Integer.parseInt(key);
            System.out.println("Key in Text: " + Key);
            String binaryKey = strTobin(Key);
            ...
            JOptionPane.showMessageDialog(null,"Key in Text: "+ Key + "\n Key in Binary: "+ binaryKey
                    +"\n56 bit Original key:    " + permutatedKey.replaceAll("(.{8})(?!$)", "$1 "));
            ...
            binaryKey = strTobin(PlainText);
            pw.println("Plain Text in Binary: " + binaryKey);
            binaryKey = binaryKey.replace(" ", "");
            String BinaryText = binaryKey;
            JOptionPane.showMessageDialog(null,"Plain Text: "+ PlainText + "\nPlain Text in Binary: "+ binaryKey);
            // Use plainTextBinary to form a loop
            int plainTextLength = binaryKey.length();
            if (plainTextLength < 64) {
                JOptionPane.showMessageDialog(null,"Your Plain text It must be atleast 64-bits(8 characters)");
